...
def init_args():
    ...
    parser.add_argument(
        "--layout_dict_path",
        type=str,
        default="../ppocr/utils/dict/layout_dict/layout_table_dict.txt") 
    parser.add_argument(
...
def parse_args():
    parser = init_args()
    #注意工作路径
    parser.set_defaults(layout_model_dir='extract/PaddleTabDet/interface/picodet_lcnet_x1_0_fgd_layout_table_infer')
    parser.set_defaults(layout_dict_path = "extract/PaddleTabDet/ppocr/utils/dict/layout_dict/layout_table_dict.txt")
